...
export default function MiddleLayout() {
    ...
    return (
        ...
        <div style={{maxWidth:"100%",width:"50%",marginTop:100}} className='container'> 
            ...
            <Paper variant='outlined'>
                    <Box p={1} className={classes.boxBorder} style={{ textAlign: "center" }}>
                        <Link className='inventoryLink' to='/middle/sroom' style={{ color: "black", textDecoration: "none" }}>Department</Link>
                </Box>
            </Paper>
            <br></br><br></br>
            <Paper variant='outlined'>
                    <Box p={1} className={classes.boxBorder} style={{ textAlign: "center" }}>
                        <Link className='' to='/' style={{ color: "red", textDecoration: "none" }}>Logout</Link>
                </Box>
            </Paper>
